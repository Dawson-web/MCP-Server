  ...
  javascript: [
    {
      ...
      answer:
        "作用域是变量的可访问范围。闭包是一个函数和其周围状态的引用的组合。",
    ...
    },
    {
      ...
      answer:
        "Promise 是异步编程的一种解决方案，表示一个异步操作的最终完成或失败。",
  ...
  react: [
    {
      ...
      answer:
        "React 生命周期包括挂载、更新和卸载三个阶段，每个阶段都有对应的生命周期方法。",
      tags: ["React", "组件"],
    },
  ],
  css: [
    {
      ...
      answer:
        "Flexbox 适用于一维布局，Grid 适用于二维布局。两者都是现代 CSS 布局的重要技术。",
      tags: ["CSS", "布局"],
    },
  ],
};
